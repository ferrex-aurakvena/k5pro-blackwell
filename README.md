...
## Project Updates
- 🔥 ```2025/11/24```: LoRas for Camera control is open-sourced: [Kandinsky 50 Video Lite LoRAs](https://huggingface.co/collections/kandinskylab/kandinsky-50-video-lite-loras) and [Kandinsky 50 Video Pro LoRAs](https://huggingface.co/collections/kandinskylab/kandinsky-50-video-pro-loras). Inference code is avaibale in `examples/inference_examples_i2v_lora.ipynb` and `examples/inference_examples_t2v_lora.ipynb`
